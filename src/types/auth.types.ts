...
export const PERMISSIONS = {
  ...
  VIEW_PARTNER_ORDERS: 'view_partner_orders'
} as const;

// Role-based permissions
export const ROLE_PERMISSIONS = {
  customer: [PERMISSIONS.CANCEL_OWN_ORDERS, PERMISSIONS.VIEW_OWN_ORDERS],
  admin: [
  ...
  partner: [PERMISSIONS.CANCEL_PARTNER_ORDERS, PERMISSIONS.VIEW_PARTNER_ORDERS],
  system: [
