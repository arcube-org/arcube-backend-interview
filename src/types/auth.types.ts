...
export const ROLE_PERMISSIONS = {
  ...
  admin: [PERMISSIONS.CANCEL_ANY_ORDER, PERMISSIONS.VIEW_AUDIT_TRAIL, PERMISSIONS.ADMIN_ACCESS],
  customer_service: [PERMISSIONS.CANCEL_ANY_ORDER, PERMISSIONS.VIEW_AUDIT_TRAIL],
  partner: [PERMISSIONS.CANCEL_PARTNER_ORDERS],
  system: [PERMISSIONS.CANCEL_SYSTEM_ORDERS, PERMISSIONS.VIEW_AUDIT_TRAIL]
} as const; 